  ...
  ## Reto 1: Únete al Dominio

  Unir el equipo Windows 11 al dominio. La configuación de red está mal y deben arrglarla.

  ## Reto 2: No puedo trabajar

  Un usuario está bloqueado y no puede iniciar sesión.

  ## Reto 3: El nuevo de la oficina

  Crear usuario y asignarlo a los grupos correspondientes.
  
  ## Reto 4: Amplíame el disco que me quedo corto
  ...
  La máquina Windows 11 apunta a un servidor WSUS que está fallando ¿Cuál es?